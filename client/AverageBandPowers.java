...
public class AverageBandPowers {
	public static final String URL = "http://foohackathon.pythonanywhere.com/home/post/";
	
	static int nf = 0;
	public static int getFocusValue() {
		return nf;
	}
	public static void setFocusValue(int val){
		nf = val;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		timer.schedule(new FocusMonitor(),0, 500);
			...
			if (ready) {
	            ...
	            for(int i = 3 ; i < 17 ; i++)
	            {
	                ...
	                if(result == EdkErrorCode.EDK_OK.ToInt()){
	                	if (low_beta.getValue() == 0 || high_beta.getValue() == 0) {
	                		continue;
	                	}
	                	if (high_beta.getValue()>=20 || low_beta.getValue()>=20)
	                		setFocusValue(nf+1);
//	                	System.out.print((int)low_beta.getValue()); System.out.print(", ");
//	                	System.out.print((int)high_beta.getValue()); System.out.print(", ");
//	                	
